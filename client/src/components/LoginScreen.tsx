...
export default function LoginScreen({ onLogin }: LoginScreenProps) {
  return (
    <div className="flex flex-col items-center justify-center min-h-[80vh]">
      <div className="discord-animation mb-6">
        <img 
      ...
      <Card className="bg-[hsl(var(--discord-background-secondary))] max-w-md w-full border-none shadow-lg">
        <CardContent className="p-8">
          <h2 className="text-2xl font-bold text-center mb-6">Connect with Discord</h2>
          <p className="text-[hsl(var(--discord-text-muted))] mb-8 text-center">
            Sign in with your Discord account to access your dashboard.
          </p>
          
          <Button 
            className="w-full bg-[hsl(var(--discord-blurple))] hover:bg-[hsl(var(--discord-blurple-dark))] py-6"
            onClick={onLogin}
          >
            <svg 
          ...
          <div className="mt-6 text-center text-sm text-[hsl(var(--discord-text-muted))]">
            By connecting, you agree to share your Discord profile information.
          </div>
        </CardContent>
      </Card>
    </div>
